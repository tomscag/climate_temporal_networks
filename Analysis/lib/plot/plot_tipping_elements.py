...
class plot_tipping_elements(PlotterEarth):
    ...
    def draw_tau_network(self):
        ...
        plt.savefig(f"{self.resfolder}tipping_{self.year}_tau.png",dpi=self.params['dpi'])




    def draw_variation_network(self,baseline=[2022]):   # TODO: different classes for each plot?
